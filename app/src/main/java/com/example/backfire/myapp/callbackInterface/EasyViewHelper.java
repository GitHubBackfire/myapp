...
import com.example.backfire.myapp.easy_adapter.EasyHolder;
 ...
 * @date 2016/7/21.
 */
public interface EasyViewHelper {

    interface AbsListView<VH extends EasyHolder> {
        /**
         * 设置textView文本内容
         *
         * @param viewId viewId
    ...
    interface RecyclerView<VH extends EasyHolder> {
        /**
         * 设置textView文本内容
         *
         * @param viewId viewId
