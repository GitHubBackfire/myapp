...
public class CommonSimpleAdapter extends  CommonBaseAdapter {
    @Override
    protected void onViewHolderBound(CommonBaseViewHolder holder, int position) {
